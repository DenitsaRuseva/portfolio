...
import {faHome, faUserSecret, faCameraRetro, faShoppingCart, faLocationArrow} from '@fortawesome/free-solid-svg-icons';
    ...
    return(
        <nav className='navigation-items'>
            ...
            <NavigationItem link='/about'><span><span>ABOUT</span><FontAwesomeIcon icon={faUserSecret} className='nav-svg'></FontAwesomeIcon></span>
                ...
                <NavigationItem link='/contacts' ><span><span>CONTACTS</span><FontAwesomeIcon icon={faLocationArrow} className='nav-svg'></FontAwesomeIcon></span>
                </NavigationItem>
        </nav>
    );
};